...
const seedData = {
  ...
  agencias: [
    { id: 16, nombre: 'Viajes Paradiso', logo: '🌴', email: 'paradiso@viajes.com', telefono: '555-0001', descripcion: 'Especialistas en viajes de lujo y experiencias únicas. Más de 20 años creando memorias inolvidables.' },
    { id: 17, nombre: 'TurMex Adventures', logo: '🦅', email: 'turmex@viajes.com', telefono: '555-0002', descripcion: 'Aventuras por todo México con guías expertos y rutas exclusivas.' },
    { id: 18, nombre: 'Sol y Playa Tours', logo: '☀️', email: 'solplaya@viajes.com', telefono: '555-0003', descripcion: 'Los mejores destinos de playa en México y el Caribe.' },
    { id: 19, nombre: 'Mundo Azteca', logo: '🏛️', email: 'azteca@viajes.com', telefono: '555-0004', descripcion: 'Viajes culturales y arqueológicos por las raíces de México.' },
    { id: 20, nombre: 'Destinos Mágicos', logo: '✨', email: 'magicos@viajes.com', telefono: '555-0005', descripcion: 'Pueblos mágicos y experiencias auténticas mexicanas.' }
  ],
  paquetes: [
    { 
    ...
    database.get('SELECT COUNT(*) as count FROM destinos', async (err, row) => {
      ...
      try {
        ...
        for (const agencia of seedData.agencias) {
          await runQuery(database,
            'INSERT OR IGNORE INTO agencias (id, nombre, logo, email, telefono, descripcion) VALUES (?, ?, ?, ?, ?, ?)',
            [agencia.id, agencia.nombre, agencia.logo, agencia.email, agencia.telefono, agencia.descripcion]
          );
        }
        console.log(`✅ ${seedData.agencias.length} agencias insertadas`);
